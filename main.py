...
def draw_game_over():
    global clicked, level, pause, game_over, menu, points, total_shots, time_remaining, time_passed
    if mode == 0:
...
def draw_pause():
    global level, pause, menu, points, total_shots, time_remaining, time_passed, clicked, new_coords
